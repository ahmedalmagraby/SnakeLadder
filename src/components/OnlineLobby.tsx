            ...
            {isHost ? (
              <button
                ...
                className={`w-full font-display text-lg tracking-wider py-3.5 rounded-xl transition-all min-h-[48px] ${
                  canStart
                    ? 'bg-gradient-to-b from-amber-300 via-amber-400 to-amber-500 text-[var(--theme-btn-text)] border-b-4 border-amber-700 shadow-[0_8px_24px_var(--theme-accent-glow)] hover:brightness-105 active:translate-y-0.5 cursor-pointer'
        ...
        {tab === 'host' ? (
          <div id="host-panel" role="tabpanel" aria-labelledby="host-tab" className="space-y-3.5 text-left">
            ...
            <button
              ...
              className="w-full font-display text-lg tracking-wider py-3 rounded-xl bg-gradient-to-b from-amber-300 via-amber-400 to-amber-500 text-[var(--theme-btn-text)] border-b-4 border-amber-700 shadow-[0_8px_20px_var(--theme-btn-glow)] hover:brightness-105 active:translate-y-0.5 cursor-pointer min-h-[48px]"
            >
          ...
          <div id="join-panel" role="tabpanel" aria-labelledby="join-tab" className="space-y-3.5 text-left">
            ...
            <button
              ...
              className={`w-full font-display text-lg tracking-wider py-3 rounded-xl transition-all min-h-[48px] ${
                inputCode.trim()
                  ? 'bg-gradient-to-b from-amber-300 via-amber-400 to-amber-500 text-[var(--theme-btn-text)] border-b-4 border-amber-700 shadow-[0_8px_20px_var(--theme-btn-glow)] hover:brightness-105 active:translate-y-0.5 cursor-pointer'
                  : 'bg-emerald-900/40 text-emerald-500/50 border border-emerald-800/40 cursor-not-allowed'
              }`}
            >
